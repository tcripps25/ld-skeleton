    ...
    <div class="flex justify-between mb-5">
      <div class="grid gap-4 grid-cols-2">
        <div>
          ...
          <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">{{ course.numberOfWeeks }}</p>
        </div>
        <div>
          <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">
            Total Activities
          ...
          <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">{{ course.totalActivities }}</p>
        </div>
      </div>
      <div>
