...
<template>
    <div class="grow w-full max-w-7xl"
        :class="sidebar ? 'bg-transparent !w-auto -mx-10 px-10 pt-5 rounded-none' : 'mb-5 mx-auto'">
        ...
        <div :id="titleSlug() + '-panel-content'" v-if="sectionVisible">
