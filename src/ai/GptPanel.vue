...
<template>
    <Button v-if="apiKey" label="Activity Assistant" @click="visible = true"
        pt:root:class="bg-sky-600 text-sm hover:bg-sky-500 text-sky-50 px-3 py-2 flex rounded-md flex gap-1 items-center mt-0 justify-center w-max">
        Activity Assistant
